        ...
        builder: (context, gameSnapshot) => gameSnapshot.hasData
            ? Scaffold(
                        ...
                        Expanded(
                          child: ListView.builder(
                              ...
                              itemBuilder: (context, index) => StreamBuilder<PlayerModel>(
                                  ...
                                  builder: (context, playerSnapshot) => ListTile(
                                      title: Text(
                                          '${index + 1}. ${playerSnapshot.hasData ? gameSnapshot.data.leaderboard[index].display(playerSnapshot.data) : '...'}')))),
                        )
                      ],
                    )),
                floatingActionButton: FloatingActionButton(
                    ...
                    onPressed: () =>
                        Navigator.push(context, MaterialPageRoute(builder: (context) => NewMatch(game: gameSnapshot.data)))),
              )
